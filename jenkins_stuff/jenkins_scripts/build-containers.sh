...
sudo docker run -d -p 5000:5000 --name frontend:latest lukef2021/frontend:latest 

cd ~/jenkins_stuff/backend
sudo docker run -d -p 5001:5001 --name backend:latest lukef2021/backend:latest
EOF